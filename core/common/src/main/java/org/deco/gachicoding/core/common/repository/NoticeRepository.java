...
public interface NoticeRepository extends JpaRepository<Notice, Long> {
    ...
    Page<Notice> findByNotContentContainingIgnoreCaseAndNotActivateTrueOrNotTitleContainingIgnoreCaseAndNotActivateTrueOrderByNotIdxDesc(String notContent, String notTitle, Pageable pageable);
